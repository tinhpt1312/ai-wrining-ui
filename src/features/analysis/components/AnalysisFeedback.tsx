  ...
  return (
    <div className="card-elevated p-4 sm:p-5">
      <div className="flex items-center justify-between gap-3">
        ...
        <span
          className={`text-sm font-bold ${scoreTextColor(criterion.score)}`}
        >
          {criterion.score}/10
        </span>
      </div>
    ...
    <Tabs defaultValue={defaultTab} className="w-full">
      ...
      {data.sampleWriting && (
        <TabsContent value="sample" className="mt-2">
          <div className="card-elevated border-primary/20 p-6">
            <h2 className="text-base font-bold text-fg tracking-tight mb-1">
              Bài viết mẫu
            </h2>
            <p className="text-sm text-muted mb-4">
              Phiên bản tham khảo áp dụng các gợi ý cải thiện — giúp bạn hình
              dung bài viết hoàn chỉnh hơn.
            </p>
